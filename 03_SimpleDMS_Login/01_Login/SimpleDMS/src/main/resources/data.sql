...
INSERT INTO TB_USER
VALUES (
           'forbob@naver.com',               -- 1. 이메일
           '$2a$10$TG1a5ywSrGNgf7/fFH.m0.EdTzHax8AGYNeAr8aIseF3DKyO0lDti',  -- 2. 암호화 된 비밀번호
           'forbob',                         -- 3. 사용자명
           'ROLE_ADMIN',                     -- 4. 역할 (권한)
           'N',                              -- 5. 계정 활성 여부 (예: 'Y' 또는 'N')
           TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), -- 6. 가입일시 (현재 날짜와 시간)
           NULL,                             -- 7. 마지막 로그인 일시 (아직 로그인하지 않은 경우)
           NULL                              -- 8. 기타 필요한 사용자 정보 (예: 추가적인 사용자 속성)
       );
