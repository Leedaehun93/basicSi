/* C:\Work\07_Si\03_SimpleDMS_Login\01_Login\frontend-react-new\src\pages\basic\dept\DeptList.tsx */
// 전체조회페이지 + 페이징
// async ~ await 코딩
// TODO: import
...
function DeptList() {
  ...
  // TODO: 전체조회 함수 : Promise 비동기 코딩 방식
  const retrieveDept = () => {
  ...
  // todo: 주의점) useEffect(()=>{},[]) 이 형태로 사용해야 에러가 발생안함
